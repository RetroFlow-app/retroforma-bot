...
function migrateUsersTable() {
    addColumnIfMissing("users", "xp", "INTEGER DEFAULT 0");
    addColumnIfMissing("users", "level", "INTEGER DEFAULT 1");
    addColumnIfMissing("users", "current_streak", "INTEGER DEFAULT 0");
    addColumnIfMissing("users", "best_streak", "INTEGER DEFAULT 0");
    addColumnIfMissing("users", "last_submission_date", "TEXT");
...
// Tworzymy tabele przy starcie modułu, jeśli baza jest jeszcze pusta.
// Aktualizuje starsze bazy o pola potrzebne do weryfikacji zgłoszeń.
function migrateSubmissionsTable() {
    const hadStatusColumn = hasColumn("submissions", "status");

    addColumnIfMissing("submissions", "status", "TEXT DEFAULT 'PENDING'");
    addColumnIfMissing("submissions", "approved_by", "TEXT");
    addColumnIfMissing("submissions", "approved_at", "TEXT");
    addColumnIfMissing("submissions", "rejected_by", "TEXT");
    addColumnIfMissing("submissions", "rejected_at", "TEXT");
    addColumnIfMissing("submissions", "reject_reason", "TEXT");
